...
public interface UserBackendService extends FrameworkBackendService<UserEntity> {
	 ...
	 * @throws com.deniz.balanced.user.business.exception.PasswordWrongException
	 ...
	 * @throws com.deniz.balanced.user.business.exception.NotValidIdException
	 *             throws if a critical fail is detected
	 * @throws com.deniz.balanced.user.business.exception.AncestorInviteLimitReachedException
