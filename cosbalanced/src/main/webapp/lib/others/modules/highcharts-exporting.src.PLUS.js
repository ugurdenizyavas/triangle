...
defaultOptions.exporting = {
	...
	url: '/basicservices/services/renderSVG',
	width: 800,
	buttons: {
		exportButton: {
			//enabled: true,
...
extend(Chart.prototype, {
	 ...
	 */	
	 getSVG: function(additionalOptions) {
		...
		if (!doc.createElementNS || doc.getBBoxOverride) {	 
			doc.getBBoxOverride = true;		 								
		...
		each(chart.series, function(serie) {
			...
			each(serie.data, function(point) {
				...
				pointOptions = {
					...
					open:point.open, //  needed for candlestick export
					high:point.high,
					low:point.low, 
					close:point.close
				};
