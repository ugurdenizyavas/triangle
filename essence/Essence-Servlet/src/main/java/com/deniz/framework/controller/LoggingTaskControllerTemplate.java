...
public abstract class LoggingTaskControllerTemplate extends MultiActionController {
     ...
     *
     * @param request        The HttpServletRequest that will be used to extract the
     *                       service url, e.g. "flight.newReportBackOffice/header/next"
     * @param abstractDto    the dto that was persisted.
     * @param event          The event that happened, e.g. "User pressed next."
     * @param systemReaction How did the system react, e.g.
     ...
     * @param request                   The HttpServletRequest that will be used to extract the
     *                                  service url, e.g. "flight.newReportBackOffice/header/next"
     * @param businessObjectType        e.g. "SearchField"
     * @param businessObjectTechnicalPk The technical key used ito identify the business object e.g.
     *                                  "45"
     * @param info                      Headline type info about the business object, e.g.
     *                                  "reportNumber"
     * @param event                     The event that happened, e.g. "User pressed next."
     * @param systemReaction            How did the system react, e.g.
     *                                  "Show previous task with errors because report contained validation errors."
     * @see LoggingTaskControllerTemplate#logServiceCall(javax.servlet.http.HttpServletRequest, com.deniz.framework.dto.AbstractDto, String, String)
     */
     ...
     *
     * @param url            The service url, e.g. "flight.newReportBackOffice/header/next"
     * @param typeAndPk      e.g. 'ReportDto:7887' or 'Field:45'
     * @param info           should be taken from AbstractDto.getInfo or
